...
The useRouteMatch hook is useful when we want to use a '' and it will give us access to matching data, including all of the times  we render something. Including the exact and strict options.

2. How would you explain form validation to someone who has never programmed before?

form validation should occur with the server. Once the client has entered all their needed date and pressed a submit button JS will validate that data on the clients PC before sending it to the server.

3. In 1-2 sentences, define end to end testing.

 End to end testing is a test that we use to see how an application is performing from start to finish. It also will ensure that the right info is passed between system components as intended. 
